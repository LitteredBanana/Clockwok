...
- Beli di **`/enchanter`** menggunakan **Minecraft EXP**.
- Bisa juga dijual antar pemain melalui **`/ah`**.
...
## Estimasi Total EXP untuk Semua Tier

| Skenario | Total EXP |
|---|---|
| Beli 1 buku per tier (8 buku) | **204,800 EXP** |
| Beli 5 buku per tier (40 buku) | **1,024,000 EXP** |
